# EcoData Hub - Environmental Data Management Platform

![version](https://img.shields.io/badge/version-1.0.0-blue.svg) ![status](https://img.shields.io/badge/status-development-orange.svg) ![license](https://img.shields.io/badge/license-MIT-green.svg)
...
EcoData Hub is a comprehensive environmental laboratory data management system built by Smebye EcoData Insights. Built on React with Material-UI components and powered by Google Cloud services, it provides a modern, scalable solution for managing environmental data from sample collection through analysis and reporting.
